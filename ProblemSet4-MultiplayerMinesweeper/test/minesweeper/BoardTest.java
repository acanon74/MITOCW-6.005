 ...
 *
 * Special cases:
 * Inizialization with 0, 1, small and big dimensions.
 *
 * Test strategy:
 ...
 * - Setting a square which is part of the a boundary.
 *
...
public class BoardTest {
    ...
    public Board bigEmptyBoard() {
        return new Board(10,10);
    }

    public ArrayList<Pair<Integer, Integer>> drawingToBoard(char[][] originalBoard) {

        ArrayList<Pair<Integer, Integer>> bombs = new ArrayList<>();

        for(int i = 0; 0 < originalBoard.length; i++) {
    ...
    public void setSquareTest() {
        ...
        assertEquals(expectedBoard, board.board);
        ...
        assertEquals(expectedBoard, board.board);
        //should had removed it
        assertEquals(expectedBoard.bombLocations.remove(new Pair(0, 3)), board.bombLocations);
        ...
        assertEquals("true", board.setSquare(1, 6, "dug"));
        expectedBoard.board[1][6] = 'F';
        assertEquals(expectedBoard.board, board.board);
        expectedBoard.bombLocations.remove(new Pair<>(1, 6));
        assertEquals(expectedBoard.bombLocations, board.bombLocations);
        ...
        assertEquals("false", board.setSquare(1, 6, "dug"));
        assertEquals(expectedBoard.board, board.board);
        ...
        expectedBoard.board[2][5] = '4';

        assertEquals("true", board.setSquare(2, 5, "set"));
        assertEquals(expectedBoard.board, board.board);
    }
    ...
    public void getNumberActiveBombsTest() {
        ...
        assertEquals(10, board.getNumberActiveBombs());
